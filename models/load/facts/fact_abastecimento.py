...
class FactAbastecimento(Fact):

    def __init__(self):
        self.stg_table = self.stg_table("stg_abastecimento", "stg_abastecimento")
        self.table_name = "stg_fto_abastecimento"
        ...
        self.fact_fks = [
            ...
            {"table": "dim_produto", "schema": "dw", "fkey": "sk_produto", "bkey": "ds_ncm", "bkeyf": "ds_ncm", "type": "inner",
            ...
            # "dim_bomba_propria", "sk_tanque", "left",
            {"table": "dim_veiculo", "schema": "dw", "fkey": "sk_veiculo", "bkey": "cd_veiculo", "type": "inner", "bkeyf": "cd_veiculo",
             "tb_alias": "dim_veiculo"},
            {"table": "dim_viagem", "schema": "dw", "fkey": "sk_viagem", "bkey": "cd_viagem", "type": "left", "bkeyf": "cd_viagem",
             "tb_alias": "dim_viagem"},
        ]
        self.fact_columns = [
            ...
            {"table": "dim_viagem", "column": "sk", "alias": "sk_viagem", "schema": "dw",
             "tb_alias": "dim_viagem"},
            {"table": stg_table, "column": "cd_abastecida", "alias": "cd_abastecida", "schema": "stage",
             "tb_alias": stg_table},
            {"table": stg_table, "column": "nr_notafiscal", "alias": "nr_notafiscal", "schema": "stage",
             "tb_alias": stg_table},
            {"table": stg_table, "column": "nr_litros", "alias": "nr_quantidade", "schema": "stage",
             "tb_alias": stg_table},
            {"table": stg_table, "column": "nr_valorunitario", "alias": "nr_preco", "schema": "stage",
             "tb_alias": stg_table},
